...
def doctor_cmd(
    ...
    diagnostico.append({
        ...
        "requerido": False,
        "detalle": gcc_path or "No encontrado (requerido para modo trace dinámico)",
    })
    ...
    tabla = Table(title="🏥 Diagnóstico del Entorno SEBASTIAN (doctor)", border_style="cyan")
