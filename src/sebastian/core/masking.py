...
SEBASTIAN detecta recursión buscando el nombre de la función con expresiones
regulares sobre su cuerpo. Sin enmascarar, el nombre mencionado en un
comentario o dentro de un `printf` cuenta como llamada recursiva.
